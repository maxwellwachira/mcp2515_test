...
enum Ecu29BitAddresses {
  ECU1_EXTENDED  =   0x18DAF110,
  ECU2_EXTENDED  =   0x18DAF120,
  ECU3_EXTENDED  =   0x18DAF130,
  ECU4_EXTENDED  =   0x18DAF140,
  ECU5_EXTENDED  =   0x18DAF150,
  ECU6_EXTENDED  =   0x18DAF160,
  ECU7_EXTENDED  =   0x18DAF170,
  ECU8_EXTENDED  =   0x18DAF180
};
...
public:
  ...
  String readDTC(uint8_t mode);
  String getAllDTCs(uint8_t mode);
